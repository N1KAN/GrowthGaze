              ...
              <DndProvider backend={HTML5Backend}>
                <div className="chart-grid grid grid-cols-1 sm:grid-cols-3  gap-4 p-4">
                  ...
                  {selectedCharts.length < 6 && (
                    <section className="sm:w-auto bg-gray-200 text-gray-600 p-2 rounded-lg shadow-md hover:bg-gray-300 flex justify-center items-center">
                      <button
                          onClick={togglePopup}
                          className="add-chart-button text-9xl w-full h-fit "
                      >
                        +
                      </button>
